...
public class PatientRegister implements Initializable {
                ...
                try {
                    ...
                    if (resultSet.next()) {
                        ...
                        String message = "Thanks for Registering. You have been Assigned to Dr. " +doctorName+ " of "+coressDept+ " Department." +
                                " Your Appointment has been set for today. Please LOG-IN to check your Report after Appoinment.";
                        showToast(message);
                    } else {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (con == null) {
            ...
            lblErrors.setTextFill(Color.GREEN);
            lblErrors.setText("Server is up");  //let the user know connection to database is established
        }
